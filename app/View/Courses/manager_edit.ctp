...
<div class="col-lg-10 well">
    ...
    <fieldset>
        ...
        //echo $this->Html->link($attachment['Attachment']['attachment'], array('controller' => 'courses', 'action' => 'sendFile', $attachment['Attachment']['id']));
        //echo $this->Html->link('<button class="btn btn-mini btn-warning" type="button">xóa</button>', array('controller' => 'Attachments', 'action' => 'delete', $attachment['Attachment']['id']), array('escape' => false));
        //echo '<br/>';
