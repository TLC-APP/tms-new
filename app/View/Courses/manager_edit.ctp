...
<div class="col-lg-10 well">
    ...
    <fieldset>
        ...
        debug($this->Form); 
        //echo $this->Html->link($attachment['attachment'], array('controller' => 'courses', 'action' => 'sendFile', $attachment['id']));
        //echo $this->Html->link('<button class="btn btn-mini btn-warning" type="button">xóa</button>', array('controller' => 'Attachments', 'action' => 'delete', $file['DinhKem']['id']), array('escape' => false));
        echo '<br/>';
