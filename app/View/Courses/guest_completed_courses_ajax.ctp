        ...
        <?php foreach ($courses as $course): ?>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 text-center">
                <div class="album-cover">
                    <?php echo $this->Html->link((!empty($matches[1][0])) ? $this->Html->image($matches[1][0], array('class' => 'img-responsive')) : $this->Html->image('training_default.jpg', array('class' => 'img-responsive'), array('class' => 'img-responsive', 'alt' => '')), array('guest' => true, 'controller' => 'courses', 'action' => 'view', $course['Course']['id']), array('class' => 'add-button fancybox.ajax', 'escape' => false)) ?>
