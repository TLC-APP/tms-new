        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li ><a data-toggle="tab" href="#tab_2-1">Lịch học</a></li>
                    <li class=""><a data-toggle="tab" href="#tab_2-6">Thông tin</a></li>
                    <li class="active"><a data-toggle="tab" href="#tab_1-7">Nội dung</a></li>
                </ul>
                <div class="tab-content">
                    <div id="tab_1-7" class="tab-pane active">
                        <div class="noi_dung" >
