            ...
            <table class="table-hover table">
                ...
                <?php foreach ($courses as $course): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            echo $this->Html->link($course['Course']['name'], array('controller' => 'courses', 'action' => 'view', $course['Course']['id']));
                        ...
                        <td class="tools">
                            ...
                            <?php
                            echo $this->Form->postLink('<span class="fa fa-ban"></span>', array('manager' => false, 'action' => 'huy', $course['Course']['id']), array('escape' => false), __('Bạn có chắc hủy khóa học # %s?', $course['Course']['name'] . ' - ' . $course['Chapter']['name']));
